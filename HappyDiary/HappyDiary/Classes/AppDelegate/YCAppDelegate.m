...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    YCTabViewController *rootTB = [[YCTabViewController alloc] init];
    
    rootTB.viewControllers = @[diaryVC, eventVC, hourglassVC, settingVC];
